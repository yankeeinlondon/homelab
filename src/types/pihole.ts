import type { Dictionary, DnsName, Integer, Ip4Address, Or, Suggest } from "inferred-types";
import type { HttpVerb } from "./general";
...
export type PiholeQueryCountsByTypes = {
...
export type PiholeQueryReplies = {
    UNKNOWN: number;
    NODATA: number;
    NXDOMAIN: number;
    CNAME: number;
...
export type PiholeQueries__History = {
    total: number;
    blocked: number;
