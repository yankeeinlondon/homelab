import { isKindError, type KindErrorType } from "@yankeeinlondon/kind-error";
import chalk from "chalk";
import { isDefined, isNumber, isObject, isString, type Dictionary } from "inferred-types";
import { CROSS } from "~/constants";
import { PiholeApiError } from "~/errors";
import type { HttpVerb, PiholeApiConfig } from "~/types";
import { endpoint,  warn } from "~/utils";
