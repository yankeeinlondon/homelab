import type { Domain, PiholeQuery, PiholeQueryOptions, PiholeQueryCountsByTypes, PiholeTopClient, PiholeStatsSummary, PiholeHistory, PiholeClient__History, PiholeClientHistoryTimestamp } from "~/types";
import { piholeApiCall } from "./api";
import { isUndefined, type Integer } from "inferred-types";
